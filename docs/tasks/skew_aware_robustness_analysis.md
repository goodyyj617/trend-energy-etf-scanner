...
The stationary bootstrap uses economic daily returns, geometric block lengths with restart probability `1 / mean_block_length`, fixed root seed 20260728, observed path length 2332, and percentile intervals. Strategy and SPY use identical block indices within every relative-performance path, preserving contemporaneous dependence. Missing observations are not filled because validation requires a complete common matrix. Partial calendar years remain in the daily bootstrap as observed economic returns; annual gate eligibility is not reused here. CAGR uses the observed calendar span. Block-boundary splicing and regime non-stationarity remain limitations, and reported probabilities are not guaranteed future probabilities.

Every Qualified strategy uses at least 5,000 paths at mean block length 20. The primary uses 10,000. Primary sensitivity:

| Mean block | Paths | P(CAGR > 0) | 5th pct CAGR | 95th pct MDD magnitude |
| ---: | ---: | ---: | ---: | ---: |
| 5 | 5,000 | 88.22% | -1.69% | 40.48% |
| 20 | 10,000 | 88.78% | -1.63% | 39.66% |
| 60 | 5,000 | 86.80% | -1.97% | 41.08% |

Primary block-20 results: P(ending equity > USD 1,000) 88.78%, P(CAGR > 0) 88.78%, jointly resampled P(CAGR > SPY) 3.37%, 5th-percentile ending equity USD 858.43, 5th-percentile CAGR -1.63%, 95th-percentile MDD magnitude 39.66%, and 5th-percentile Calmar -0.047.
...
| --- | --- |
| `score_bo_l10_rm002_erp005__first_signal__low10` | largest_behavioral_equivalence_group |
| `score_bo_l10_rm002_erp010__first_signal__low10` | best_worst_crash_drawdown, largest_behavioral_equivalence_group |
| `score_bo_l10_rm002_erp015__first_signal__low10` | largest_behavioral_equivalence_group, lowest_es95 |
| `score_bo_l10_rp000_erp005__first_signal__low10` | largest_behavioral_equivalence_group |
| `score_bo_l10_rp000_erp010__first_signal__low10` | best_worst_crash_drawdown, largest_behavioral_equivalence_group |
| `score_bo_l10_rp000_erp015__first_signal__low10` | largest_behavioral_equivalence_group, lowest_es95 |
| `score_bo_l20_rm002_erp005__first_signal__low10` | largest_behavioral_equivalence_group |
| `score_bo_l20_rm002_erp010__first_signal__low10` | largest_behavioral_equivalence_group, lowest_cdar95 |
| `score_bo_l20_rm002_erp015__first_signal__low10` | largest_behavioral_equivalence_group, lowest_mdd |
| `score_bo_l20_rp000_erp005__first_signal__low10` | largest_behavioral_equivalence_group |
| `score_bo_l20_rp000_erp010__first_signal__low10` | largest_behavioral_equivalence_group, lowest_bootstrap_95pct_mdd, lowest_cdar95 |
| `score_bo_l20_rp000_erp015__first_signal__low10` | largest_behavioral_equivalence_group, lowest_mdd |
| `score_bo_l20_rp002_erp010__first_signal__low10` | shortest_longest_time_under_water |
| `score_bo_l40_rm002_erp005__signal_3d_confirm__low20` | largest_behavioral_equivalence_group |
| `score_bo_l40_rm002_erp005__signal_3d_confirm__low20_minus_0_5atr` | largest_behavioral_equivalence_group |
| `score_bo_l40_rm002_erp005__signal_3d_confirm__ma50` | largest_behavioral_equivalence_group |
| `score_bo_l40_rm002_erp010__signal_3d_confirm__low20` | largest_behavioral_equivalence_group |
| `score_bo_l40_rm002_erp010__signal_3d_confirm__low20_minus_0_5atr` | largest_behavioral_equivalence_group |
| `score_bo_l40_rm002_erp010__signal_3d_confirm__ma50` | largest_behavioral_equivalence_group |
| `score_bo_l40_rm002_erp015__signal_3d_confirm__low20` | largest_behavioral_equivalence_group |
| `score_bo_l40_rm002_erp015__signal_3d_confirm__low20_minus_0_5atr` | largest_behavioral_equivalence_group, lowest_cost_sensitivity |
| `score_bo_l40_rm002_erp015__signal_3d_confirm__ma50` | largest_behavioral_equivalence_group, lowest_worst_crash_loss_capture |
| `score_bo_l40_rp000_erp005__signal_3d_confirm__low20` | largest_behavioral_equivalence_group |
| `score_bo_l40_rp000_erp005__signal_3d_confirm__low20_minus_0_5atr` | largest_behavioral_equivalence_group |
| `score_bo_l40_rp000_erp005__signal_3d_confirm__ma50` | largest_behavioral_equivalence_group |
| `score_bo_l40_rp000_erp010__signal_3d_confirm__low20` | largest_behavioral_equivalence_group |
| `score_bo_l40_rp000_erp010__signal_3d_confirm__low20_minus_0_5atr` | largest_behavioral_equivalence_group |
| `score_bo_l40_rp000_erp010__signal_3d_confirm__ma50` | largest_behavioral_equivalence_group |
| `score_bo_l40_rp000_erp015__signal_3d_confirm__low20` | largest_behavioral_equivalence_group |
| `score_bo_l40_rp000_erp015__signal_3d_confirm__low20_minus_0_5atr` | largest_behavioral_equivalence_group, lowest_cost_sensitivity |
| `score_bo_l40_rp000_erp015__signal_3d_confirm__ma50` | largest_behavioral_equivalence_group, lowest_worst_crash_loss_capture |
| `score_bo_l40_rp002_erp005__signal_3d_confirm__low20` | fastest_mean_exposure_reduction |
| `score_bo_l40_rp002_erp010__signal_3d_confirm__low20` | fastest_mean_exposure_reduction |
| `score_bo_l40_rp002_erp015__signal_3d_confirm__low20` | fastest_mean_exposure_reduction |
| `score_bo_l40_rp002_erp015__signal_3d_confirm__low20_minus_0_5atr` | best_worst_full_year_loo, highest_bootstrap_5pct_cagr, highest_bootstrap_prob_cagr_positive, highest_cagr, highest_calmar, highest_dsr_raw, highest_psr_vs_zero, lowest_best_day_concentration |

Strict dominance requires no worse performance in all ten declared dimensions and strict improvement in at least one. The strict frontier contains 22 strategies:

`score_bo_l10_rm002_erp015__first_signal__low10`, `score_bo_l10_rp000_erp010__first_signal__low10`, `score_bo_l10_rp000_erp015__first_signal__low10`, `score_bo_l20_rm002_erp010__first_signal__low10`, `score_bo_l20_rp000_erp010__first_signal__low10`, `score_bo_l20_rp000_erp015__first_signal__low10`, `score_bo_l20_rp002_erp010__first_signal__low10`, `score_bo_l40_rm002_erp015__signal_3d_confirm__low20`, `score_bo_l40_rm002_erp015__signal_3d_confirm__low20_minus_0_5atr`, `score_bo_l40_rm002_erp015__signal_3d_confirm__ma50`, `score_bo_l40_rp000_erp015__signal_3d_confirm__low20`, `score_bo_l40_rp000_erp015__signal_3d_confirm__low20_minus_0_5atr`, `score_bo_l40_rp000_erp015__signal_3d_confirm__ma50`, `score_bo_l40_rp002_erp005__signal_3d_confirm__low20`, `score_bo_l40_rp002_erp005__signal_3d_confirm__low20_minus_0_5atr`, `score_bo_l40_rp002_erp005__signal_3d_confirm__ma50`, `score_bo_l40_rp002_erp010__signal_3d_confirm__low20`, `score_bo_l40_rp002_erp010__signal_3d_confirm__low20_minus_0_5atr`, `score_bo_l40_rp002_erp010__signal_3d_confirm__ma50`, `score_bo_l40_rp002_erp015__signal_3d_confirm__low20`, `score_bo_l40_rp002_erp015__signal_3d_confirm__low20_minus_0_5atr`, `score_bo_l40_rp002_erp015__signal_3d_confirm__ma50`

The tolerance frontier uses 1 bp for CAGR/bootstrap CAGR/cost sensitivity, 0.001 for DSR and portfolio/crash-return risk rates, 0.01 for crash capture, and 5 days for time under water. It contains 18 strategies:

`score_bo_l10_rm002_erp015__first_signal__low10`, `score_bo_l10_rp000_erp010__first_signal__low10`, `score_bo_l10_rp000_erp015__first_signal__low10`, `score_bo_l20_rm002_erp010__first_signal__low10`, `score_bo_l20_rp000_erp015__first_signal__low10`, `score_bo_l20_rp002_erp010__first_signal__low10`, `score_bo_l40_rm002_erp015__signal_3d_confirm__low20`, `score_bo_l40_rm002_erp015__signal_3d_confirm__low20_minus_0_5atr`, `score_bo_l40_rp000_erp015__signal_3d_confirm__low20_minus_0_5atr`, `score_bo_l40_rp000_erp015__signal_3d_confirm__ma50`, `score_bo_l40_rp002_erp005__signal_3d_confirm__low20`, `score_bo_l40_rp002_erp005__signal_3d_confirm__low20_minus_0_5atr`, `score_bo_l40_rp002_erp010__signal_3d_confirm__low20`, `score_bo_l40_rp002_erp010__signal_3d_confirm__low20_minus_0_5atr`, `score_bo_l40_rp002_erp010__signal_3d_confirm__ma50`, `score_bo_l40_rp002_erp015__signal_3d_confirm__low20`, `score_bo_l40_rp002_erp015__signal_3d_confirm__low20_minus_0_5atr`, `score_bo_l40_rp002_erp015__signal_3d_confirm__ma50`
...
| Bootstrap 5th-percentile CAGR | -3.43% | -1.64% | 0.32% |
